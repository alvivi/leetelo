...
stalingradoCopy1 = Copy(user=testUser, book=stalingradoBook, offerType="Intercambio", offerState="En oferta",language="Castellano",pages=735,edition=8,genre="Novela").put()
civCopy1 = Copy(user=testUser, book=civBook, offerType="Intercambio", offerState="En oferta",language="Castellano",pages=441,edition=8,genre="Novela").put()
decadenCopy1 = Copy(user=testUser, book=decadenBook, offerType="Intercambio", offerState="En oferta",language="Castellano",pages=435,edition=8,genre="Novela").put()
mesopCopy1 = Copy(user=testUser, book=mesopBook, offerType="Intercambio", offerState="En oferta",language="Castellano",pages=335,edition=8,genre="Novela").put()
rivertonCopy1 = Copy(user=testUser, book=rivertonBook, offerType="Intercambio", offerState="En oferta",language="Castellano",pages=457,edition=8,genre="Novela").put()

jtCopy1    = Copy(user=nilsenUser, book=jtBook, offerType="Prestamo",offerState="En oferta",language="Frances",pages=250,edition=1,genre="Novela").put()
cienCopy1 = Copy(user=nilsenUser, book=cienBook, offerType="Venta", offerState="En oferta",language="Frances",pages=255,edition=6,genre="Novela").put()
mistCopy1  = Copy(user=nilsenUser, book=mistBook, offerType="Intercambio", offerState="En oferta",language="Frances",pages=200,edition=4,genre="Novela").put()
...
club3 = Club(name=u'fans de Haruki Murakami',description=u'Este club va dirigido a los fans de...', author=u'Haruki Murakami', genre= [u'Poesia',u'Novela'],invitaciones = [u'patrypons@example.com',u'billy@gates.com'],state=u'Habilitado', book=cieloBook, owner= testUser, image=db.Link('http://2.bp.blogspot.com/__7FN-K-p0ws/TL2YKFVWofI/AAAAAAAAAMA/MK5mIMWJc1o/s1600/hmurakami.jpg')).put()
club4 = Club(name=u'El club de la comedia',description=u'Este club va dirigido a los fans de...', author=u'Federico Moccia', genre= [u'Narrativa',u'Biografía'],invitaciones = [u'billy@gates.com',u'test@example.com'],state=u'Habilitado', book=cieloBook, owner = nilsenUser, image=db.Link('http://s3.amazonaws.com/kym-assets/photos/images/original/000/096/044/trollface.jpg?1296494117')).put()
club5 = Club(name=u'Fans de Knut Hamsun',description=u'Este club va dirigido a los fans de...', author=u'Knut Hamsun', genre= [u'Narrativa',u'Biografía'],invitaciones = [u'billy@gates.com',u'test@example.com',u'patrypons@example.com',u'lol@example.com'],state=u'Habilitado', owner = nilsenUser, image=db.Link('http://farm3.static.flickr.com/2711/4437964112_b114fa90b6.jpg')).put()
...
club7 = Club(name=u'Adictos a la historia',description=u'Este club va dirigido a los fans de...',  genre= [u'Historico',u'Biografía'],invitaciones = [u'test@example.com'],state=u'Habilitado', owner = nilsenUser, image=db.Link('http://www.satlogo.com/logo/hires/cc/canal_de_historia.png')).put()
