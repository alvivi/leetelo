...
club4 = Club(name=u'aswtaeta',description=u'Este club va dirigido a los fans de...', author=u'Haruki Murakami', genre= [u'Poesia',u'Novela'],invitaciones = [u'test@example.com',u'billy@gates.com'],state=u'Habilitado', book=cieloBook, owner= nilsenUser).put()
