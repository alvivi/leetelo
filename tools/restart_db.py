...
club5 = Club(name=u'Fans de Knut Hamsun',description=u'Este club va dirigido a los fans de...', author=u'Knut Hamsun', genre= [u'Narrativa',u'Biografía'],invitaciones = [u'billy@gates.com',u'test@example.com',u'patriciapons89@gmail.com',u'lol@example.com'],state=u'Habilitado', owner = nilsenUser, image=db.Link('http://farm3.static.flickr.com/2711/4437964112_b114fa90b6.jpg')).put()
